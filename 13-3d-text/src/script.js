...
// Matcaps are reference picture relating to camera position and everything;
...
fontLoader.load("/fonts/helvetiker_regular.typeface.json", (font) => {
  ...
  //   Using translates on geometry will move all the vertices, but keeps the mesh the same
